...
Guide d'installation et configuration des drivers de base de données.

## Vue d'Ensemble

CSWeb Community Platform supporte **3 drivers PDO** pour la flexibilité multi-SGBD :
...
Driver pour Microsoft SQL Server.
...
### Configuration Pré-installée

Le `Dockerfile` de CSWeb Community Platform pré-installe tous les drivers :
...
grep pdo_pgsql /etc/php/8.1/cli/php.ini
```
