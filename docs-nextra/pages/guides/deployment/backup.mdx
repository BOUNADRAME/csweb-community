...
Pour plus de détails, consultez le [Guide Backup Automatique](/guides/admin/backup).

## Ressources

- **Backup Automatique (intégré)** : [Backup Automatique](/guides/admin/backup)
