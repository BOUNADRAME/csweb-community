...
namespace App\CSPro\Dictionary;
...
//cases 
        ...
        $casesTable->addColumn(static::quoteString('modified_time'), "datetime", ["default" => null]);
        $casesTable->addColumn(static::quoteString('created_time'), "datetime", ["default" => null]);
